  ...
  arbitrum: [
    {
      ...
      baseBorrowingFactor: percentageToFloat("65%") / bigNumberify(SECONDS_PER_YEAR),
      aboveOptimalUsageBorrowingFactor: percentageToFloat("120%") / bigNumberify(SECONDS_PER_YEAR),
    ...
    },
    {
      ...
      optimalUsageFactor: percentageToFloat("75%"),
      baseBorrowingFactor: percentageToFloat("60%") / bigNumberify(SECONDS_PER_YEAR),
      aboveOptimalUsageBorrowingFactor: percentageToFloat("120%") / bigNumberify(SECONDS_PER_YEAR),
    },
    {
      ...
      optimalUsageFactor: percentageToFloat("75%"),
      baseBorrowingFactor: percentageToFloat("65%") / bigNumberify(SECONDS_PER_YEAR),
      aboveOptimalUsageBorrowingFactor: percentageToFloat("160%") / bigNumberify(SECONDS_PER_YEAR),
    },
    {
    ...
    },
    {
      ...
      optimalUsageFactor: percentageToFloat("75%"),
      baseBorrowingFactor: percentageToFloat("70%") / bigNumberify(SECONDS_PER_YEAR),
      aboveOptimalUsageBorrowingFactor: percentageToFloat("160%") / bigNumberify(SECONDS_PER_YEAR),
    ...
    {
      tokens: { indexToken: "USDC", longToken: "USDC", shortToken: "DAI" },
...
function fillLongShortValues(
  market: MarketConfig, 
  key: keyof MarketConfig, 
  longKey: keyof MarketConfig, 
  shortKey: keyof MarketConfig) {
  if (market[longKey] === undefined) {
    (market as any)[longKey] = market[key];
  }

  if (market[shortKey] === undefined) {
    (market as any)[shortKey] = market[key];
  }
}
  ...
  if (markets) {
    ...
    for (const market of markets) {
      ...
      for (const key of Object.keys(defaultMarketConfig)) {
        if ((market as any)[key as keyof MarketConfig] === undefined) {
          (market as any)[key] = (defaultMarketConfig as any)[key];  
        }
      }
