...
const {
  ...
  await dataStore.setUint(
    tokenTransferGasLimit("0x6C7B96639F72912a60A94BBcC80644B0dF8e6C1E"), 
    // hashData(
    //           ["bytes32", "address"],
  ...
  console.log("dataStore.getUint(tokenTransferGasLimit(await weth1.getAddress())) =============>", 
    await dataStore.getUint(tokenTransferGasLimit(await weth1.getAddress())),
...
//! npx hardhat run scriptsResearch/codeResearch.ts --network localhost > outputLogicsCode.log 2>&1
