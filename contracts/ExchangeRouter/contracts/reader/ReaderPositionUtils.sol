...
library ReaderPositionUtils {
    ...
    function getPositionInfo(
        ...
        positionInfo.fees.amounts.totalCostAmountExcludingFunding =
            positionInfo.fees.amounts.positionFeeAmount
            + positionInfo.fees.borrowing.borrowingFeeAmount
            + positionInfo.fees.ui.uiFeeAmount
            - positionInfo.fees.amounts.totalDiscountAmount;

        positionInfo.fees.amounts.totalCostAmount =
            positionInfo.fees.amounts.totalCostAmountExcludingFunding
