...
library PositionEventUtils {
    ...
    function _emitPositionFees(
        ...
        eventData.uintItems.setItem(13, "positionFeeFactor", fees.amounts.positionFeeFactor);
        eventData.uintItems.setItem(14, "protocolFeeAmount", fees.amounts.protocolFeeAmount);
        eventData.uintItems.setItem(15, "positionFeeReceiverFactor", fees.amounts.positionFeeReceiverFactor);
        eventData.uintItems.setItem(16, "feeReceiverAmount", fees.amounts.feeReceiverAmount);
        eventData.uintItems.setItem(17, "feeAmountForPool", fees.amounts.feeAmountForPool);
        eventData.uintItems.setItem(18, "positionFeeAmountForPool", fees.amounts.positionFeeAmountForPool);
        eventData.uintItems.setItem(19, "positionFeeAmount", fees.amounts.positionFeeAmount);
        eventData.uintItems.setItem(20, "totalCostAmount", fees.amounts.totalCostAmount);
